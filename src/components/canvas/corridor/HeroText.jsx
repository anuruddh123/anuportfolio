...
const HeroText = ({ position = [0, 0.3, 0] }) => {
    ...
    // Letter positions for ANURUDDH split effect
    const letters = useMemo(() => [
        { char: 'A', baseX: -1.33, splitDir: -2.0, delay: 0 },
        { char: 'N', baseX: -0.95, splitDir: -1.5, delay: 0 },
        { char: 'U', baseX: -0.57, splitDir: -1.0, delay: 0 },
        { char: 'R', baseX: -0.19, splitDir: -0.5, delay: 0 },
        { char: 'U', baseX: 0.19, splitDir: 0.5, delay: 0 },
        { char: 'D', baseX: 0.57, splitDir: 1.0, delay: 0 },
        { char: 'D', baseX: 0.95, splitDir: 1.5, delay: 0 },
        { char: 'H', baseX: 1.33, splitDir: 2.0, delay: 0 },
    ], []);

    // Tagline words for split effect
    const taglineWords = useMemo(() => [
        { text: '<', baseX: -1.0, splitDir: -1.6, delay: 0 },
        { text: 'full', baseX: -0.55, splitDir: -0.8, delay: 0 },
        { text: 'stack', baseX: -0.05, splitDir: 0.0, delay: 0 },
        { text: 'developer', baseX: 0.6, splitDir: 0.9, delay: 0 },
    ...
    useFrame((state, delta) => {
        ...
        // Apply split to each letter of ANURUDDH
    ...
    return (
        <group ref={groupRef} position={position} scale={[scale, scale, 1]}>
            {/* ANURUDDH Letters - Rubik Scribble font with fade-in animation */}
            ...
            <SmallStar position={[-1.4, -0.6, 0]} scale={0.04} />
