...
const ContactRoom = ({ showRoom, onReady, isExiting, isWarmup }) => {
    ...
    const handleMailSelect = () => {
        ...
        window.location.href = 'mailto:anuruddhtiwari2022@gmail.com';
    };
    ...
    return (
        <group ref={groupRef} position={[0, -0.7, -5]}>
            ...
            <SocialBarrel
                ...
                label="LINKEDIN"
                onClick={() => window.open('https://www.linkedin.com/in/anuruddh-tiwari-2842b232a/', '_blank')}
            ...
            <SocialBarrel
                ...
                texturePath="/textures/contact/beczka.webp"
                label="GITHUB"
                onClick={() => window.open('https://github.com/anuruddh123', '_blank')}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
            {/* RESUME */}
            <SocialBarrel
                ...
                texturePath="/textures/contact/beczka.webp"
                label="RESUME"
                onClick={() => window.open('https://drive.google.com/file/d/1E24VUyqLDMsoXqHB2dunkXiv8Eh20x4Q/view?usp=drive_link', '_blank')}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
            {/* PHONE */}
            <SocialBarrel
                ...
                texturePath="/textures/contact/beczka.webp"
                label="PHONE"
                onClick={() => window.open('tel:+917307122757', '_self')}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
            {/* MAIL (Triggers animation / mailto) */}
            <SocialBarrel
