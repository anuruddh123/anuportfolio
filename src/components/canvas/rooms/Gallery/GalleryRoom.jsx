...
const FALLBACK_PROJECTS = [
    {
        ...
        description: 'Built an AI-powered resume builder with authentication, resume customization, and PDF export. Developed server-side APIs for resume processing and integrated MongoDB for persistent user and resume data. Designed a responsive component-based interface for real-time resume editing.',
    ...
    },
    {
        ...
        description: 'Real-time news alert platform with REST APIs, user subscriptions, and personalized alerts. Implemented JWT authentication for secure registration, login, and protected user preferences. Built responsive React UI with MongoDB integration for storing subscriptions and alert data.',
    ...
    },
    {
        ...
        description: 'Built a full-stack e-commerce platform with product listings, cart management, and checkout functionality. Implemented JWT-based authentication, authorization, protected routes, and admin controls. Developed a responsive React/Tailwind frontend integrated with RESTful APIs and MongoDB.',
        techStack: ['/textures/gallery/reactlogo.webp', '/textures/gallery/tailwindlogo.webp', '/textures/gallery/jslogo.webp', '/textures/gallery/netlifylogo.webp']
    },
    {
        id: 'github-portfolio',
        ...
        description: 'Explore Anuruddh Tiwari\'s open-source projects, full-stack MERN repositories, RESTful APIs, and responsive React frontend components on GitHub.',
