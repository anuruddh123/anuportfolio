...
const STORY_MILESTONES = [
    { id: 'intro', position: [0, 0, -15], type: 'intro', title: 'ANURUDDH', subtitle: '< full stack developer />' },
    { id: 'awards', position: [0, 0, -55], type: 'awards', title: 'CERTIFICATIONS', subtitle: 'GUVI IIT-M Pravartak • GUVI HCL' },
    { id: 'journey', position: [0, 0, -95], type: 'journey', title: 'JOURNEY', subtitle: 'B.Tech CSE @ AKTU Lucknow (CGPA 8.1)' },
    { id: 'skills', position: [0, 0, -135], type: 'skills', title: 'SKILLS', subtitle: 'React.js • Node.js • Express.js • MongoDB' },
];
