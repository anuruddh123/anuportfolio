...
const AWARDS_DATA = {
    featured: {
        ...
        items: [
            { label: 'Full Stack with AI Tools - GUVI IIT-M', date: 'April 2026', image: '/textures/about/FEATURED.webp', url: 'https://resume-craftss.netlify.app/' },
            { label: 'Basic Java Programming - GUVI HCL', date: 'September 2025', image: '/textures/about/FEATURED.webp', url: 'https://resume-craftss.netlify.app/' },
            { label: 'Full Stack Trainee - GUVI Kanpur', date: '2025 - 2026', image: '/textures/about/FEATURED.webp', url: 'https://resume-craftss.netlify.app/' },
            { label: 'B.Tech CSE - AKTU Lucknow', date: '2022 - 2026', image: '/textures/about/FEATURED.webp', url: 'https://resume-craftss.netlify.app/' },
        ],
        platformConfig: {
            label: 'CREDENTIAL',
            color: '#1a1a1a',
    ...
    sotd: {
        ...
        items: [
            { label: 'GUVI IIT-M Pravartak', date: 'April 2026', image: '/textures/about/SOTDAYYOUNGMULTIGSAP.webp', url: 'https://resume-craftss.netlify.app/' },
            { label: 'GUVI, HCL Tech', date: 'September 2025', image: '/textures/about/SOTDAYYOUNGMULTICSSWINNER.webp', url: 'https://resume-craftss.netlify.app/' },
            { label: 'AKTU Lucknow (CGPA 8.1)', date: 'July 2026', image: '/textures/about/SOTDAYYOUNGMULTIORPETRON.webp', url: 'https://resume-craftss.netlify.app/' },
            { label: 'Full Stack MERN Specialization', date: 'May 2026', image: '/textures/about/SOTDAYYOUNGMULTIDESIGNNOMINESS.webp', url: 'https://resume-craftss.netlify.app/' }
        ],
        platformConfig: {
            label: 'CERTIFICATE',
            color: '#1a1a1a',
...
const JourneyMilestone = ({ z, scrollProgressRef }) => {
    ...
    return (
        <group ref={groupRef} position={[0, 0, z]}>
            ...
            {/* === UO ISLAND (Left) - B.Tech CSE AKTU Lucknow === */}
            <group ref={uoRef} position={[-3.5, -1, 0]}>
                ...
                {/* NAPIS NA WYSPIE (AKTU) */}
                <Text
                    position={[0.1, -0.85, 0.1]} // POZYCJA (X, Y, Z)
                    fontSize={0.36}          // WIELKOŚĆ
                    color="#1a1a1a"
                    anchorX="center"
                    anchorY="middle"
                    font="/fonts/CabinSketch-Bold.ttf"
                >
                    AKTU LUCKNOW (2022-2026)
                </Text>
            </group>

            {/* === FREELANCE ISLAND (Right) - GUVI Trainee === */}
...
const BALLOON_CONFIG = [
    ...
    { texture: '/textures/about/reactduzybalon.webp', paintedTexture: '/textures/about/reactduzybalon_painted.webp', label: 'React.js', size: 'large', x: -2.5, y: 2, z: 0.3, phase: 0 },
    { texture: '/textures/about/threejsduzybalon.webp', paintedTexture: '/textures/about/threejsduzybalon_painted.webp', label: 'Node.js', size: 'large', x: 2.5, y: 2.5, z: 0.2, phase: 1.5 },
    { texture: '/textures/about/GSAPduzybalon.webp', paintedTexture: '/textures/about/GSAPduzybalon_painted.webp', label: 'Express.js', size: 'large', x: 0, y: 3, z: 0.5, phase: 3 },
    ...
    { texture: '/textures/about/htmlmalybalon.webp', paintedTexture: '/textures/about/htmlmalybalon_painted.webp', label: 'HTML5/CSS3', size: 'small', x: -5.5, y: 2.5, z: -0.8, phase: 1.2 },
    ...
    { texture: '/textures/about/figmamalybalon.webp', paintedTexture: '/textures/about/figmamalybalon_painted.webp', label: 'Postman', size: 'small', x: -3, y: 4.5, z: -0.5, phase: 3.5 },
    { texture: '/textures/about/firebasemalybalon.webp', paintedTexture: '/textures/about/firebasemalybalon_painted.webp', label: 'REST APIs', size: 'small', x: 3.5, y: 4, z: -0.6, phase: 4.5 },
];
